      ...
      <div className="grid gap-5 lg:grid-cols-[0.72fr_1.28fr]">
        <Card className="text-center">
          <div className="relative mx-auto w-fit">
            ...
            <button className="absolute -bottom-1 -right-1 rounded-full bg-primary p-2 text-white"><Camera className="size-4" /></button>
          </div>
          ...
          <div className="mt-6 space-y-3 border-t border-slate-100 pt-6 text-left text-sm dark:border-slate-800">
            <p className="flex items-center gap-3"><Mail className="size-4 text-slate-400" />astha@goodday.app</p>
            <p className="flex items-center gap-3"><MapPin className="size-4 text-slate-400" />Bengaluru, India</p>
          </div>
        </Card>
        <div className="space-y-5">
          <Card>
            <CardHeader><CardTitle>Edit profile</CardTitle><Button size="sm">Save changes</Button></CardHeader>
          ...
          <Card>
            ...
            {[
              ...
              <div key={title} className="flex items-center gap-4 border-b border-slate-100 py-4 last:border-0 dark:border-slate-800">
                <Icon className="size-5 text-primary" />
                <div>
                  <p className="text-sm font-medium dark:text-white">{title}</p>
                  <p className="muted text-xs">{detail}</p>
                </div>
                <button className="ml-auto h-6 w-11 rounded-full bg-primary p-1"><span className="block size-4 translate-x-5 rounded-full bg-white" /></button>
              </div>
            ))}
          </Card>
        </div>
